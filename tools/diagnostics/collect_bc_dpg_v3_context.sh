...
#
# 使用：
#   tools/diagnostics/collect_bc_dpg_v3_context.sh
#
# 指定工程目录：
#   tools/diagnostics/collect_bc_dpg_v3_context.sh /path/to/balloon_radar_project
#
# 可选环境变量：
#   OUTPUT_DIR=~/Downloads tools/diagnostics/collect_bc_dpg_v3_context.sh
#   INCLUDE_RESULT_SAMPLES=0 tools/diagnostics/collect_bc_dpg_v3_context.sh
#
# 安全说明：
