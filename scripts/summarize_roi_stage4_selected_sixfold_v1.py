    ...
    for fold in args.folds:
        for mode in args.modes:
            ...
            rows.append({
                ...
                "range_mae": float(refined.get("range_mae_gates", refined.get("all_positive_range_mae_gates", float("nan")))),
                "velocity_mae": float(refined.get("velocity_mae_bins", refined.get("all_positive_velocity_mae_bins", float("nan")))),
