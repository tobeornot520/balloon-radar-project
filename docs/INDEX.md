...
- `MULTIDOMAIN_FEATURE_CONTRACT_AUDIT_V1.md`: executable audit of frozen feature domains, dimensions and claim gates
...
- `BC_DPG_CAUSAL_TRAINING_PROTOCOL.md`
- `ROI_BC_DPG_JOINT_NEXT_DESIGN.md`
- `polarimetric_stage3/STAGE3_FROZEN_CONCLUSION.md`
- `POLARIMETRIC_TRANSFER_ENCODER_V1.md`
...
- `ZERO_DOPPLER_TARGET_SAFETY_AUDIT_V1.md`
